...
public class adapterAnualExamen3 extends BaseAdapter {

    private Context context;
    private ArrayList<mAnualExamen3B> arrayList;
    ...
    public adapterAnualExamen3(Context context, ArrayList<mAnualExamen3B> arrayList) {
                ...
                switch (position) {
                    case 0:
                        if (cd.isConnected()) {
                            ...
                            String URL = "http://192.169.218.177/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IIB3.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2015 - II");
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IIB3.pdf";

                            ruta = "2015_IIB3.pdf";

                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/" + ruta);
                    ...
                    case 1:
                        if (cd.isConnected()) {
                            ...
                            String URL = "http://192.169.218.177/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IB3.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2015 - I");
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IB3.pdf";
                    ...
                    case 2:
                        if (cd.isConnected()) {
                            ...
                            String URL = "http://192.169.218.177/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2014_IIB3.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2014 - II");
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2014_IIB3.pdf";
                ...
                switch (position) {
                    case 0:
                        ...
                        if (cd.isConnected()) {
                            ...
                            urlADescargar = "http://192.169.218.177/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IIB3.pdf";
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "E.Admisión por Años - Bimestre 3 - 2015 II";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IIB3.pdf";
                    ...
                    case 1:
                        if (cd.isConnected()) {
                            ...
                            //http://192.169.218.177/APP/4/5/EXADM_ANUAL/BIMESTRE3/2015_IB3.pdf

                            urlADescargar = "http://192.169.218.177/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IB3.pdf";
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "E.Admisión por Años - Bimestre 3 - 2015 I";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2015_IB3.pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 2:
                        if (cd.isConnected()) {
                            ...
                            urlADescargar = "http://192.169.218.177/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2014_IIB3.pdf";
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "E.Admisión por Años - Bimestre 3 - 2014 II";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/2014_IIB3.pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
    ...
    private class DescargarPDFAsynTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... urlPDF) {
            ...
            try {
                ...
                String rutaficheroGuardado = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + ciclo + "/5/EXADM_ANUAL/BIMESTRE3/" + ruta;
