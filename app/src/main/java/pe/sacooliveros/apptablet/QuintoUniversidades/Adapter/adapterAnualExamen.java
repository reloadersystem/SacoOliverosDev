...
import pe.sacooliveros.apptablet.QuintoUniversidades.fragments.Bimestre1_AnualFragment;
...
public class adapterAnualExamen extends BaseAdapter {


    private Context context;
    private ArrayList<mAnualExamen> arrayList;
    ...
    public adapterAnualExamen(Context context, ArrayList<mAnualExamen> arrayList) {
...

                {
                    case 0:
                        if (cd.isConnected()) {
                            ...
                            String  URL= "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IB1.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2018 - I");
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IB1.pdf";

                            ruta = "2018_IB1.pdf";

                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/" + ruta);
                    ...
                    case 1:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String  URL= "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IIB1.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2018 - II");
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IIB1.pdf";
                    ...
                    case 2:
                        ...
                        String sharedata= ShareDataRead.obtenerValor(context, "TipoGradoAsiste");

                        if (sharedata.equalsIgnoreCase("UNI"))
                        {
                            tituloexamen="EXÁMEN DE ADMISIÓN 2017 - II";

                        }
                        else if(sharedata.equalsIgnoreCase("SAN MARCOS"))
                        {
                            tituloexamen="EXÁMEN DE ADMISIÓN 2019 - I";
                        }
                        ...
                        if (cd.isConnected()) {
                            ...
                            String  URL= "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2017_IIB1.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", tituloexamen);
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2017_IIB1.pdf";
              ...
              switch(position)
              {
                  case 0:
                      if (cd.isConnected()) {
                          ...
                          urlADescargar = "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IB1.pdf";
                          ...
                          if (file0.exists()) {
                              ...
                              String nombrepdfusuario = "E.Admisión por Años - Bimestre 1 - 2018 I";
                              String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IB1.pdf";
                  ...
                  case 1:
                      ...
                      if (cd.isConnected()) {
                          ...
                          urlADescargar = "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IIB1.pdf";
                          ...
                          if (file0.exists()) {
                             ...
                             // DBwritedownloas();
                              ...
                              String nombrepdfusuario = "E.Admisión por Años - Bimestre 1 - 2018 II";
                              String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2018_IIB1.pdf";
                              DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                  ...
                  case 2:
                      ...
                      if (cd.isConnected()) {
                          ...
                          urlADescargar = "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2017_IIB1.pdf";
                          ...
                          if (file0.exists()) {
                             ...
                             // DBwritedownloas();
                              ...
                              String nombrepdfusuario = "E.Admisión por Años - Bimestre 1 - 2017 II";

                              if(ciclo=="4" ||ciclo=="6")
                              {
                                  nombrepdfusuario="E.Admisión por Años - Bimestre 1 - 2019 I";
                              }


                              String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE1/2017_IIB1.pdf";
                              DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
