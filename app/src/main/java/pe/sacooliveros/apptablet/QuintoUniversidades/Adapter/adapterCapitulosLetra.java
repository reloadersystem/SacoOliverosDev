...
public class adapterCapitulosLetra extends BaseAdapter {

    private Context context;
    private ArrayList<mCapitulosAdmisionLetras> arrayList;
    ...
    public adapterCapitulosLetra(Context context, ArrayList<mCapitulosAdmisionLetras> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public static void tomoCapitulosLetras(String tomowrite) {
        tomo = tomowrite;
        tomonumero = (String.valueOf(tomo.charAt(4))); //TOMO1

    }

    public static void seleccionletras(String letras) {
        seleccionletras = letras;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (cicloespecial.equalsIgnoreCase("UNI")) {
            ...
            if (seleccionletras.equalsIgnoreCase("UNI")) {
                cicloespecial = "3";
                nivel = "5";
            }

            if (seleccionletras.equalsIgnoreCase("SAN MARCOS")) {
                cicloespecial = "4";
                nivel = "5";
            }

            if (seleccionletras.equalsIgnoreCase("CATOLICA")) {
                cicloespecial = "5";
                nivel = "5";
            }
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_admisioncapituloletras, null);

        }

        ImageView imgfoto = convertView.findViewById(R.id.img_capituloletras);

        ImageView imgfoto2 = convertView.findViewById(R.id.img_downcapituloletras);
                    ...
                    case 0:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " LENGUAJE";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/LENGUAJE/LENGUAJE" + cicloespecial + "_T" + tomonumero + ".pdf";
                    ...
                    case 1:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " LITERATURA";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/LITERATURA/LITERATURA" + cicloespecial + "_T" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 2:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " RAZONAMIENTO VERBAL";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/RAZONAMIENTO_VERBAL/RAZONAMIENTO_VERBAL" + cicloespecial + "_T" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 3:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " HISTORIA DEL PERU";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/HISTORIA_DEL_PERU/HISTORIA_DEL_PERU" + cicloespecial + "_T" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 4:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " GEOGRAFIA";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/GEOGRAFIA/GEOGRAFIA" + cicloespecial + "_T" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 5:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " HISTORIA UNIVERSAL";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/HISTORIA_UNIVERSAL/HISTORIA_UNIVERSAL" + cicloespecial + "_T" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 6:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " ECONOMIA";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/ECONOMIA/ECONOMIA" + cicloespecial + "_T" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 7:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "P.E.Adm. por Capítulos " + tomo + " PSICOLOGIA";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/PEADM_CAP/" + tomo + "/PSICOLOGIA/PSICOLOGIA" + cicloespecial + "_T" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
