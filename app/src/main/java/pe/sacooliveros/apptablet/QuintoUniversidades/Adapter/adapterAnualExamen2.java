...
import pe.sacooliveros.apptablet.QuintoUniversidades.fragments.Bimestre2_AnualFragment;
...
public class adapterAnualExamen2 extends BaseAdapter {

    private Context context;
    private ArrayList<mAnualExamen2B> arrayList;
    ...
    public adapterAnualExamen2(Context context, ArrayList<mAnualExamen2B> arrayList) {
            ...
            public void onClick(View view) {
                ...
                switch(position)
                {
                    ...
                    if (cd.isConnected()) {
                        ...
                        String  URL= "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2017_IB2.pdf";

                        Intent intent = new Intent(context, ViewTomo3Activity.class);

                        intent.putExtra("ViewType", "internet");
                        intent.putExtra("URL", URL);
                        intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2017 - I");
                        context.startActivity(intent);

                    } else {

                        String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2017_IB2.pdf";
                    ...
                    case 1:
                        if (cd.isConnected()) {
                            ...
                            String  URL= "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IIB2.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2016 - II");
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IIB2.pdf";
                    ...
                    case 2:
                        if (cd.isConnected()) {
                            ...
                            String  URL= "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IB2.pdf";

                            Intent intent = new Intent(context, ViewTomo3Activity.class);

                            intent.putExtra("ViewType", "internet");
                            intent.putExtra("URL", URL);
                            intent.putExtra("Materia", " EXÁMEN DE ADMISIÓN 2016 - I");
                            context.startActivity(intent);

                        } else {

                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IB2.pdf";
                ...
                switch(position)
                {
                    case 0:
                        ...
                        if (cd.isConnected()) {
                            ...
                            urlADescargar = "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2017_IB2.pdf";
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "E.Admisión por Años - Bimestre 2 - 2017 I";
                    ...
                    case 1:
                        ...
                        if (cd.isConnected()) {
                            ...
                            urlADescargar = "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IIB2.pdf";
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "E.Admisión por Años - Bimestre 2 - 2016 II";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IIB2.pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 2:
                        ...
                        if (cd.isConnected()) {
                            ...
                            urlADescargar = "http://192.169.218.177/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IB2.pdf";
                            ...
                            if (file0.exists()) {
                               ...
                               // DBwritedownloas();
                                ...
                                String nombrepdfusuario = "E.Admisión por Años - Bimestre 2 - 2016 I";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/2016_IB2.pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
    ...
    private class DescargarPDFAsynTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... urlPDF) {
            ...
            try {
                ...
                String rutaficheroGuardado = "/data/user/0/pe.sacooliveros.apptablet/files/APP/"+ciclo+"/5/EXADM_ANUAL/BIMESTRE2/" + ruta;
