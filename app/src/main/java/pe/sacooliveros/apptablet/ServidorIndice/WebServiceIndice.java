...
public class WebServiceIndice {
    ...
    public static void urlvisor(String urlinfo) {
        urldatavisor = urlinfo;
        int auth = urldatavisor.length();

        String urlconstructor = urldatavisor.substring(0, auth - 4);

        urlfinal = urlconstructor + ".json";
    }
