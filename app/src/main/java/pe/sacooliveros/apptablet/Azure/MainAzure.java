package pe.sacooliveros.apptablet.Azure;
...
public class MainAzure extends AppCompatActivity {
    ...
    private static final String TAG = MainAzure.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loging.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(MainAzure.this, NavActivity.class);
...
//                Log.d(TAG,"url" + request.getUrl());
    ...
    private  void callGraphAPIPHOTO() {
        ...
        photorequest= new JsonObjectRequest(Request.Method.GET, MSGRAPH_URL_PHOTO,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Log.d(TAG, "Response PHOTO: " + response);
                ...
                public Map<String, String> getHeaders() throws AuthFailureError {
                    ...
                    Log.d(TAG, "tokenAPP "+ authResult.getAccessToken()+ " copiarToken");
    ...
    void downloadFile() {
        ...
        try {
            ...
            URL imageUrl = null;
            imageUrl = new URL("https://graph.microsoft.com/beta/me/photo/$value");
            HttpURLConnection conn = (HttpURLConnection) imageUrl.openConnection();
            conn.setRequestProperty("Authorization","Bearer " + TOKEN);
            //conn.setRequestProperty("Authorization","Bearer " + authResult.getAccessToken());
