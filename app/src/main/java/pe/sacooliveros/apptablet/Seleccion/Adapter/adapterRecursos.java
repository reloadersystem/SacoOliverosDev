...
public class adapterRecursos extends BaseAdapter {

    private Context context;
    private ArrayList<mRecursos> arrayList;

    public adapterRecursos(Context context, ArrayList<mRecursos> arrayList) {
