...
public class adapterDiecisiete extends BaseAdapter {

    Context context;
    ArrayList<mDiecisiete> arrayList;

    public adapterDiecisiete(Context context, ArrayList<mDiecisiete> arrayList) {
