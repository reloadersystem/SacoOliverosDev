...
public class adapterInternacionales extends BaseAdapter {

    private Context context;
    private ArrayList<mInternacionales> arrayList;


    public adapterInternacionales(Context context, ArrayList<mInternacionales> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView==null)
        {
            convertView= LayoutInflater.from(context).inflate(R.layout.item_internacionales,null);
