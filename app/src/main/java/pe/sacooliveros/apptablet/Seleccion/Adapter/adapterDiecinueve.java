...
public class adapterDiecinueve extends BaseAdapter {

    Context context;
    ArrayList<mDiecinueve> arrayList;


    public adapterDiecinueve(Context context, ArrayList<mDiecinueve> arrayList) {
