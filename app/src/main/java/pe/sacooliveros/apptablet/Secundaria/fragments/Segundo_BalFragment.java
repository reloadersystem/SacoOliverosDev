...
//        }
        ...
        listaBalotarioss.add(new mBalotarios(R.drawable.publicaciones5, "Algebra", R.drawable.downloadpublic, "Algebra - " + balotariotipo, "Algebra" + balotariotipo, numperiodo + "/SOLUCIONARIO_" + tipoperiodo + "/"));
