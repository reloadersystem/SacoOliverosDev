...
public class adapterTomo extends BaseAdapter {


    private Context context;
    private ArrayList<mTomo> arrayList;

    public adapterTomo(Context context, ArrayList<mTomo> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView==null)
        {
            convertView= LayoutInflater.from(context).inflate(R.layout.item_tomos,null);
