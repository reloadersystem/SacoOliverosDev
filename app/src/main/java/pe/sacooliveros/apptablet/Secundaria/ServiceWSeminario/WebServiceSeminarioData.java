...
public class WebServiceSeminarioData

{
    ...
    public String requestFromWebService(String host, Integer port, String method, String... params) {
        String rString = "";
        int response;
        ...
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                try (InputStream iStream = new BufferedInputStream(conn.getInputStream());
