...
public class adapter_letras extends BaseAdapter {

    private Context context;

    private ArrayList<mLetras> arrayList;
    ...
    public adapter_letras(Context context, ArrayList<mLetras> arrayList) {
    ...
    public static void tomoletrascompendios(String tomowrite) {
        tomo = tomowrite;
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_letras, null);

        }

        ImageView imgfoto = convertView.findViewById(R.id.img_letraslist);
        ImageView imgfoto2 = convertView.findViewById(R.id.img_letrasdescargacompendios);
            ...
            public void onClick(View view) {
...

                {
                    ...
                    case 1:
                        ...
                        //http://192.169.218.177/APP/4/5/COMPENDIOS/TOMO1/LITERATURA/LITERATURA25_CT1.pdf
                        ...
                        if (cd.isConnected()) {
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/LITERATURA/LITERATURA2" + nivel + "_CT" + tomonumero + ".pdf";
                    ...
                    case 2:
                        ...
                        //http://192.169.218.177/APP/2/5/COMPENDIOS/TOMO1/RAZONAMIENTO_VERBAL/RAZONAMIENTO_VERBAL25_CT1.pdf
                    ...
                    case 3:
                        ...
                        if (cd.isConnected()) {
                            ...
                            //http://192.169.218.177/APP/4/5/COMPENDIOS/TOMO1/HISTORIA_DEL_PERU/HISTORIA_DEL_PERU25_CT1.pdf
                    ...
                    case 4:
                        ...
                        if (cd.isConnected()) {
                            ...
                            //http://192.169.218.177/APP/4/5/COMPENDIOS/TOMO1/GEOGRAFIA/GEOGRAFIA25_CT1.pdf
                    ...
                    case 0:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - LENGUAJE ";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/LENGUAJE/LENGUAJE2" + nivel + "_CT" + tomonumero + ".pdf";
...
//                                DBwritedownloas();
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - LITERATURA ";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/LITERATURA/LITERATURA2" + nivel + "_CT" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 2:
                        ...
                        if (cd.isConnected()) {
                            ...
                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/RAZONAMIENTO_VERBAL/" + tomo + "/" + materiadownload + ruta);
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - RAZONAMIENTO VERBAL ";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/RAZONAMIENTO_VERBAL/RAZONAMIENTO_VERBAL2" + nivel + "_CT" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 3:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - HISTORIA DEL PERU ";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/HISTORIA_DEL_PERU/HISTORIA_DEL_PERU2" + nivel + "_CT" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 4:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - GEOGRAFIA";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/GEOGRAFIA/GEOGRAFIA2" + nivel + "_CT" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 5:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - HISTORIA UNIVERSAL";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/HISTORIA_UNIVERSAL/HISTORIA_UNIVERSAL2" + nivel + "_CT" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 6:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - ECONOMIA";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/ECONOMIA/ECONOMIA2" + nivel + "_CT" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 7:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Compendios - " + tomo + " - PSICOLOGIA";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/" + cicloespecial + "/" + nivel + "/COMPENDIOS/" + tomo + "/PSICOLOGIA/PSICOLOGIA2" + nivel + "_CT" + tomonumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
