...
public class adapterResueltosCiencia extends BaseAdapter {

    private Context context;
    private ArrayList<mTomoCienciasResueltos> arrayList;
    ...
    public adapterResueltosCiencia(Context context, ArrayList<mTomoCienciasResueltos> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_resueltosproblemas, null);

        }

        ImageView imgfoto = convertView.findViewById(R.id.img_cienciaresuelto);

        ImageView imgfoto2 = convertView.findViewById(R.id.img_downcienciaresuelto);
...

                {
                    case 0:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/FISICA/FISICA2" + nivel + "_PRM" + mesnumero + ".pdf";
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/FISICA/FISICA2" + nivel + "_PRM" + mesnumero + ".pdf";

                            ruta = "FISICA2" + nivel + "_PRM" + mesnumero + ".pdf";

                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/FISICA/" + ruta);
                    ...
                    case 1:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/QUIMICA/QUIMICA2" + nivel + "_PRM" + mesnumero + ".pdf";
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/QUIMICA/QUIMICA2" + nivel + "_PRM" + mesnumero + ".pdf";

                            ruta = "QUIMICA2" + nivel + "_PRM" + mesnumero + ".pdf";

                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/QUIMICA/" + ruta);
                    ...
                    case 2:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/BIOLOGIA/BIOLOGIA2" + nivel + "_PRM" + mesnumero + ".pdf";
...
//                          String URL = servidor_ruta+"/APP/1/"+accesodato+"/LIBROS/"+tomo+"/MATEMATICA/GEOMETRIA/Geometria_T"+tomonumero+".pdf";
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/BIOLOGIA/BIOLOGIA2" + nivel + "_PRM" + mesnumero + ".pdf";


                            ruta = "BIOLOGIA2" + nivel + "_PRM" + mesnumero + ".pdf";


                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/BIOLOGIA/" + ruta);
                    ...
                    case 3:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ARITMETICA/ARITMETICA2" + nivel + "_PRM" + mesnumero + ".pdf";
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ARITMETICA/ARITMETICA2" + nivel + "_PRM" + mesnumero + ".pdf";


                            ruta = "ARITMETICA2" + nivel + "_PRM" + mesnumero + ".pdf";


                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ARITMETICA/" + ruta);
                    ...
                    case 4:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ALGEBRA/ALGEBRA2" + nivel + "_PRM" + mesnumero + ".pdf";
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ALGEBRA/ALGEBRA2" + nivel + "_PRM" + mesnumero + ".pdf";

                            ruta = "ALGEBRA2" + nivel + "_PRM" + mesnumero + ".pdf";


                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ALGEBRA/" + ruta);
                    ...
                    case 5:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/GEOMETRIA/GEOMETRIA2" + nivel + "_PRM" + mesnumero + ".pdf";
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/GEOMETRIA/GEOMETRIA2" + nivel + "_PRM" + mesnumero + ".pdf";

                            ruta = "GEOMETRIA2" + nivel + "_PRM" + mesnumero + ".pdf";

                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/GEOMETRIA/" + ruta);
                    ...
                    case 6:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/TRIGONOMETRIA/TRIGONOMETRIA2" + nivel + "_PRM" + mesnumero + ".pdf";
                            ...
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/TRIGONOMETRIA/TRIGONOMETRIA2" + nivel + "_PRM" + mesnumero + ".pdf";
...
//                            ruta = "Calculo_MentalT"+tomonumero+".pdf";
                            ...
                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/TRIGONOMETRIA/" + ruta);
...
//                                    + File.separator + "SacoOliveros" + File.separator + ruta);
                    ...
                    case 7:
                        ...
                        if (cd.isConnected()) {
                            ...
                            String URL = servidor_ruta + "/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/RAZONAMIENTO_MATEMATICO/RAZONAMIENTO_MATEMATICO2" + nivel + "_PRM" + mesnumero + ".pdf";
...
//                            String URL = servidor_ruta+"/APP/1/"+accesodato+"/LIBROS/"+tomo+"/MATEMATICA/CALCULO_MENTAL/Calculo_MentalT"+tomonumero+".pdf";
                            ...
                            //String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/1/"+accesodato+"/LIBROS/"+tomo+"/MATEMATICA/CALCULO_MENTAL/Calculo_MentalT"+tomonumero+".pdf";
                            String ssdFile = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/RAZONAMIENTO_MATEMATICO/RAZONAMIENTO_MATEMATICO2" + nivel + "_PRM" + mesnumero + ".pdf";
...
//                            ruta = "Calculo_MentalT"+tomonumero+".pdf";
                            ...
                            //File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/1/"+accesodato+"/LIBROS/"+tomo+"/MATEMATICA/CALCULO_MENTAL/" + ruta);
                            File file0 = new File("/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/RAZONAMIENTO_MATEMATICO/" + ruta);
                    ...
                    case 0:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/FISICA/FISICA2" + nivel + "_PRM" + mesnumero + ".pdf";
...
//                                    + File.separator + "SacoOliveros" + File.separator + ruta);
                            ...
                            if (file0.exists()) {
                                ...
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/QUIMICA/QUIMICA2" + nivel + "_PRM" + mesnumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
...
//                                    + File.separator + "SacoOliveros" + File.separator + ruta);
                            ...
                            if (file0.exists()) {
                                ...
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/BIOLOGIA/BIOLOGIA2" + nivel + "_PRM" + mesnumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 3:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ARITMETICA/ARITMETICA2" + nivel + "_PRM" + mesnumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
...
//                                DBwritedownloas();
                                ...
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/ALGEBRA/ALGEBRA2" + nivel + "_PRM" + mesnumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 5:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/GEOMETRIA/GEOMETRIA2" + nivel + "_PRM" + mesnumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 6:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/TRIGONOMETRIA/TRIGONOMETRIA2" + nivel + "_PRM" + mesnumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
                    ...
                    case 7:
                        ...
                        if (cd.isConnected()) {
                            ...
                            if (file0.exists()) {
                                ...
                                String nombrepdfusuario = "Problemas Propuestos - MES " + mesnumero + " - RAZONAMIENTO MATEMATICO";
                                String rutasdd = "/data/user/0/pe.sacooliveros.apptablet/files/APP/2/" + nivel + "/PROBLEMAS_RESUELTOS/MES" + mesnumero + "/RAZONAMIENTO_MATEMATICO/RAZONAMIENTO_MATEMATICO2" + nivel + "_PRM" + mesnumero + ".pdf";
                                DownloadListWrite.WriteDownloads(context, nombrepdfusuario, rutasdd, urlADescargar, "true");
