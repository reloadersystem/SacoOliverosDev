...
public class adapterInit extends BaseAdapter {

    private Context context;
    private ArrayList<mInit> arrayList;


    public adapterInit(Context context, ArrayList<mInit> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup)
    {
        if(convertView==null)
        {
            convertView= LayoutInflater.from(context).inflate(R.layout.item_initial,null);
